      ...
      <>
        ...
        <nav>
            ...
            <div className='perfil' >
                <img src={perfil} className="perfil-icon" alt="perfil-icon" />
                     ...
                     <div className='infor-perfil' onClick={toggleDropdown}>
                        <div className='nome-usuario'>
                            <span id='nomeUser'>Tamires</span>
                            <FontAwesomeIcon icon={faChevronDown} />
                        </div>
                             <span id='nivelAcesso'>Coordenadora</span>
                        </div>
              ...
              <div className='notificacao' onClick={toggleNotificacao}>
                <img src={notificacao} alt='icon-notificao' />
              </div>

              {notificacaoOpen && (
                <div className="notificacao-dropdown">
                  <div className="notificacao-header">Notificação</div>
                  <div className="notificacao-content">
                    <div className="legenda">
                      <span className="importante"></span> Importante
                    </div>
                    <div className="legenda">
                      <span className="nao-importante"></span> Não tão importante
                    </div>
                  </div>
                </div>
              )}
